...
def calculate_math(expression):
    ...
    try:
        ...
        # ============================================================
        # 1) SOLVING EQUATIONS (With Step-by-Step for Linear/Quadratic)
        # ============================================================
        if "solve" in expression:
            ...
            # Convert to polynomial form (if possible)
...
\end{{aligned}}"""
            ...
            # -----------------------------------------
            # Higher-degree or Non-Polynomial:
            # fallback to sp.solve
            # -----------------------------------------
            else:
